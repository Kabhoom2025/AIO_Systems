...
/// <summary>PBKDF2-based hasher (salt + iterations embedded in the stored string) - no external
/// identity provider dependency, consistent with sibling services' custom auth approach.</summary>
