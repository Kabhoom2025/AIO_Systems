import{a as P}from"./chunk-C2LGCBEQ.js";import{da as q,ea as g,ja as A}from"./chunk-YVXIKYMN.js";import{g as Q,i as E,n as N,r as O}from"./chunk-YIFEAXLI.js";import{$ as T,Bc as B,Cb as u,Db as d,Eb as x,Fb as M,Gb as w,Nb as l,Ob as D,Pb as F,Sb as f,Ub as m,V as v,Vb as y,W as h,Wa as o,Zb as j,_b as S,ec as z,gb as b,hb as C,ia as p,kb as $,mb as r,tb as i,wb as k,xb as I}from"./chunk-MNLHA4RB.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
