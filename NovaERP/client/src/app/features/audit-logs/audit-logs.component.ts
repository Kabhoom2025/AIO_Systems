...
import { AuditLogApiService, AuditLogDto, PagedResult } from '../../core/audit-log-api.service';
...
export class AuditLogsComponent implements OnInit {
  ...
  constructor(
    private api: AuditLogApiService,
  ...
  loadLogs(): void {
    this.loading = true;
    this.api.getPaged(this.page, this.pageSize, this.searchTerm || null).subscribe({
