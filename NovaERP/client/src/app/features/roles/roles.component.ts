...
import { RoleApiService, RoleDto, CreateRoleDto, UpdateRoleDto } from '../../core/role-api.service';
import { PermissionApiService, PermissionDto } from '../../core/permission-api.service';
...
@Component({
  ...
  imports: [
    ...
    InputTextModule, TagModule, MultiSelectModule, ConfirmDialogModule, ToastModule, HasPermissionDirective
  ],
...
export class RolesComponent implements OnInit {
  ...
  saveAdd() {
    this.saving = true;
    this.roleApi.create(this.addForm).subscribe({
      next: () => {
        this.saving = false;
  ...
  saveEdit() {
    ...
    this.saving = true;
    this.roleApi.update(this.editRoleId, this.editForm).subscribe({
      next: () => {
        this.saving = false;
