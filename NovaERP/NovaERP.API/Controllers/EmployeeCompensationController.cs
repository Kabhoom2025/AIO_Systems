...
[Authorize]
public class EmployeeCompensationController : ApiControllerBase
{
    private readonly IEmployeeCompensationService _service;

    public EmployeeCompensationController(IEmployeeCompensationService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateEmployeeCompensationDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateEmployeeCompensationDto dto) =>
