...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-BLT7H3AV.js").then((m) => m);
...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-R7PGJUSK.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    loadComponent: () => import("./chunk-ABJED6GT.js").then((m) => m.ShellComponent),
    canActivate: [authGuard],
    children: [
      { path: "", pathMatch: "full", redirectTo: "workflows" },
      {
        path: "workflows",
        loadComponent: () => import("./chunk-P6UE4RUZ.js").then((m) => m.WorkflowsListComponent)
      },
      {
        path: "workflows/:id",
        loadComponent: () => import("./chunk-GTLLTPTR.js").then((m) => m.WorkflowBuilderComponent)
      }
    ]
  },
  { path: "**", redirectTo: "" }
