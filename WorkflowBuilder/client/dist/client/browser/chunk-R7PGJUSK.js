...
var LoginComponent = class _LoginComponent {
  ...
  static \u0275fac = function LoginComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoginComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(NotificationService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 12, vars: 5, consts: [[1, "login-page"], ["header", "Workflow Builder", 1, "login-card"], [1, "form-field"], ["pInputText", "", "type", "email", "placeholder", "admin@workflowbuilder.local", 3, "ngModelChange", "keyup.enter", "ngModel"], ["styleClass", "full-width", 3, "ngModelChange", "keyup.enter", "ngModel", "feedback", "toggleMask"], ["pButton", "", "type", "button", "label", "Log in", 1, "full-width", 3, "click", "loading"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "div", 0)(2, "p-card", 1)(3, "div", 2)(4, "label");
      \u0275\u0275text(5, "Email");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("keyup.enter", function LoginComponent_Template_input_keyup_enter_6_listener() {
        return ctx.submit();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div", 2)(8, "label");
      \u0275\u0275text(9, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "p-password", 4);
      \u0275\u0275twoWayListener("ngModelChange", function LoginComponent_Template_p_password_ngModelChange_10_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.password, $event) || (ctx.password = $event);
        return $event;
      });
      \u0275\u0275listener("keyup.enter", function LoginComponent_Template_p_password_keyup_enter_10_listener() {
        return ctx.submit();
      });
      \u0275\u0275elementEnd()();
  ...
  }, dependencies: [CommonModule, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, InputTextModule, InputText, PasswordModule, Password, ButtonModule, ButtonDirective, CardModule, Card, ToastModule, Toast], styles: ["\n\n.login-page[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  background: #f4f6f9;\n}\n.login-card[_ngcontent-%COMP%] {\n  width: 360px;\n}\n.form-field[_ngcontent-%COMP%] {\n  margin-bottom: 1rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.375rem;\n}\n.form-field[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: #374151;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n[_nghost-%COMP%]     .full-width input {\n  width: 100%;\n}\n/*# sourceMappingURL=login.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    type: Component,
    args: [{ selector: "app-login", standalone: true, imports: [CommonModule, FormsModule, InputTextModule, PasswordModule, ButtonModule, CardModule, ToastModule], template: '<p-toast></p-toast>\n<div class="login-page">\n  <p-card header="Workflow Builder" class="login-card">\n    <div class="form-field">\n      <label>Email</label>\n      <input pInputText type="email" [(ngModel)]="email" (keyup.enter)="submit()" placeholder="admin@workflowbuilder.local" />\n    </div>\n    <div class="form-field">\n      <label>Password</label>\n      <p-password [(ngModel)]="password" [feedback]="false" [toggleMask]="true" (keyup.enter)="submit()" styleClass="full-width"></p-password>\n    </div>\n    <button pButton type="button" label="Log in" class="full-width" [loading]="loading" (click)="submit()"></button>\n  </p-card>\n</div>\n', styles: ["/* src/app/features/login/login.component.scss */\n.login-page {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  background: #f4f6f9;\n}\n.login-card {\n  width: 360px;\n}\n.form-field {\n  margin-bottom: 1rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.375rem;\n}\n.form-field label {\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: #374151;\n}\n.full-width {\n  width: 100%;\n}\n:host ::ng-deep .full-width input {\n  width: 100%;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], () => [{ type: AuthService }, { type: Router }, { type: NotificationService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "app/features/login/login.component.ts", lineNumber: 20 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-R7PGJUSK.js.map
